import pytest
import requests
from automated_tests.api_testing_practice.go_rest.test_data.headers import headers
from automated_tests.api_testing_practice.go_rest.test_data.payloads import post_payload, patch_payload
import os
